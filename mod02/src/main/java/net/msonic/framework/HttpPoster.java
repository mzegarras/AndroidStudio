...
public class HttpPoster {
    ...
    private String executeHttpPostWithRetry() throws Exception {
        ...
        try {
            ...
            Log.d(TAG, String.format("Headers:%s", connection.getRequestProperties().toString()));
            Log.d(TAG, String.format("RQ:%s", sf.toString()));

            //Send request
            DataOutputStream wr = new DataOutputStream(connection.getOutputStream());
            wr.writeBytes(sf.toString());
            wr.flush();
            wr.close();

            Log.d(TAG, String.format("Headers:%s", connection.getHeaderFields().toString()));
            Log.d(TAG, String.format("Status:%s", connection.getResponseCode()));
            ...
            Log.d(TAG, String.format("RS:%s", response));
